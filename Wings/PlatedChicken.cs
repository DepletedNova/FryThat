...
{
    public class PlatedChicken : CustomItemGroup<ItemGroupView>
    {
        public override string UniqueNameID => "Plated Chicken";
        ...
        public override GameObject Prefab => GetPrefab("Plated Chicken");
